    ...
    float ScreenMessageDuration)
{
    ...
    switch (Category)
    {
        ...
        case ESolaraqLogCategory::Shield:
            ...
            break;
        case ESolaraqLogCategory::Fishing:
            LogCategoryName = LogSolaraqFishing.GetCategoryName();
            break;
        case ESolaraqLogCategory::Minimap:
            LogCategoryName = LogSolaraqMinimap.GetCategoryName();
            break;
    case ESolaraqLogCategory::Mining:
        LogCategoryName = LogSolaraqMining.GetCategoryName();
        break;
